...
import src.revenue_distribution.non_optimized.DistributionContract;

import java.util.HashMap;
import java.util.Map;
import java.util.concurrent.TimeUnit;

import static benchmarking.revenue_distribution.NonOptimizedSimulation.Contracts.*;
...
public class NonOptimizedSimulation {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options opt = new OptionsBuilder()
                .include(NonOptimizedSimulation.class.getSimpleName())
                .build();
