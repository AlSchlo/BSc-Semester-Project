...
import "./OptimizedDistribution.sol";

contract BenchmarkOptimizedDistribution is OptimizedDistribution {

    uint constant NB_USERS = 10000;

    constructor() 
        OptimizedDistribution(generateAddresses(NB_USERS), generateStakes(NB_USERS)) {}
